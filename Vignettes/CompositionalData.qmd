...
And now we can start to ask questions about whether variation in the different components is associated with any demographic or other participant characteristics.
In the code below we look at fitting a spline model for age.
